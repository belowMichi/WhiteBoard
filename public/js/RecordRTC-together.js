...
function StereoAudioRecorder(mediaStream, root) {
    ...
    var volume;
    var audioInput;
    var sampleRate = 11025; //自己加 原来是44100
    var audioContext;
    var context;
    ...
    function interleave(leftChannel, rightChannel) {
		var compression = 44100 / 11025;//自己加
        var length = leftChannel.length + rightChannel.length;
        var result = new Float32Array(length/compression);//自己加 /compression
